...
namespace NFramework
{
    public class BaseUIView : MonoBehaviour
    {
        ...
        public virtual void HandleOnKeyBack() { } //update khi ma tat 1 cai dialog mo truoc no

        public virtual void OnOpen() { } //tuong tu ham Start

        public virtual void OnClose() { } //tuong tu ham onDisable
    }
}
